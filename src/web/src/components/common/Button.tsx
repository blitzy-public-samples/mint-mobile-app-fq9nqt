...
const getButtonClasses = (props: ButtonProps): string => {
  ...
  const variantClasses = {
    primary: `bg-primary-500 hover:bg-primary-600 active:bg-primary-700 focus:ring-primary-500 ${disabled ? 'opacity-50 cursor-not-allowed' : ''}`,
    ...
    danger: `bg-error-500 hover:bg-error-600 active:bg-error-700 focus:ring-error-500 ${disabled ? 'opacity-50 cursor-not-allowed' : ''}`,
